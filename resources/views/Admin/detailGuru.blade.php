...
<div class="flex flex-col space-y-6">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm flex justify-between items-center">
        <div class="flex items-center space-x-6">
            ...
            <div>
                <h2 class="text-2xl font-bold text-slate-800">Nama Guru</h2>
                <p class="text-slate-500 text-sm mb-2">NIP 1170382119</p>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm">
            <div class="space-y-6 max-w-4xl">
                ...
                <div class="grid grid-cols-3 border-b border-slate-100 pb-3">
                    ...
                    <span class="col-span-2 text-slate-600 font-medium">DD/MM/YYYY</span>
                </div>
                <div class="grid grid-cols-3 border-b border-slate-100 pb-3">
                    <span class="font-bold text-slate-800">Tempat lahir</span>
                    <span class="col-span-2 text-slate-600 font-medium">Tempat lahir Guru</span>
                </div>
                <div class="grid grid-cols-3 border-b border-slate-100 pb-3">
                    <span class="font-bold text-slate-800">Alamat</span>
                    <span class="col-span-2 text-slate-600 font-medium">Alamat Guru</span>
                </div>
                <div class="grid grid-cols-3 border-b border-slate-100 pb-3">
                ...
                <div class="grid grid-cols-3 border-b border-slate-100 pb-3">
                    ...
                    <span class="col-span-2 text-slate-600 font-medium">1170382119</span>
                </div>
                <div class="grid grid-cols-3 border-b border-slate-100 pb-3">
                ...
                <div class="grid grid-cols-3 border-b border-slate-100 pb-3">
                    ...
                    <span class="col-span-2 text-slate-600 font-medium">Agama Guru</span>
                </div>
                <div class="grid grid-cols-3 pb-3">
                    <span class="font-bold text-slate-800">Golongan darah</span>
                    <span class="col-span-2 text-slate-600 font-medium">Golongan darah Guru</span>
                </div>
            </div>
        </div>
    </div>
