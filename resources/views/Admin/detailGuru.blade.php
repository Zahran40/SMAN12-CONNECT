...
<div class="flex flex-col space-y-4 sm:space-y-6">
    ...
    <div>
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('admin.data-master.guru.edit', $guru->id_guru) }}" class="bg-green-400 hover:bg-green-500 text-white px-4 py-1.5 rounded-full flex items-center space-x-2 transition-colors text-sm font-medium">
