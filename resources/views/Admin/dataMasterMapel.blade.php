...
@section('content')
    <div class="flex flex-col h-full space-y-6">
        ...
        <a href="{{route ('admin.data_master_mapel1')}}" class="px-8 py-2 bg-blue-400 text-white font-semibold rounded-full shadow-sm hover:bg-blue-500 transition-colors">
            Mata Pelajaran
        </a>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm flex-grow">
            ...
            <div class="max-h-96 overflow-y-auto space-y-4">
                ...
                <div class="grid grid-cols-12 gap-4 items-center border-2 border-blue-100 rounded-xl px-6 py-4">
                    ...
                    <div class="col-span-4 font-semibold text-slate-800">Nama Mapel</div>
                    <div class="col-span-4 text-slate-600 font-medium">Nama Guru</div>
