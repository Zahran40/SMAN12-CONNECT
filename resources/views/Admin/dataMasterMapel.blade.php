...
@section('content')
    <div class="flex flex-col h-full space-y-6">
        ...
        <a href="{{ route('admin.data-master.kelas.mapel', $kelas->id_kelas) }}" class="px-8 py-2 bg-blue-400 text-white font-semibold rounded-full shadow-sm hover:bg-blue-500 transition-colors">
            Mata Pelajaran
        </a>
        </div>
