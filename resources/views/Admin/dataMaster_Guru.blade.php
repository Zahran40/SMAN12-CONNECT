...
@section('content')
    <div class="flex flex-col space-y-6">
        ...
        <div class="flex space-x-4">
            ...
            <a href="{{route ('admin.data_master_guru')}}" class="px-8 py-2 bg-blue-400 text-white font-semibold rounded-full border-2 hover:bg-blue-500 transition-colors">
                Guru
            </a>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm">
            <h3 class="text-xl font-bold text-blue-600 mb-6">Daftar Guru</h3>
            ...
            <div class="space-y-4 max-h-[600px] overflow-y-auto pr-2">
                ...
                <div class="grid grid-cols-12 gap-4 items-center border-2 border-blue-100 rounded-xl px-6 py-4 bg-white  ">
                    ...
                    <div class="col-span-5 font-semibold text-slate-800">Nama Guru</div>
                    <div class="col-span-4 text-slate-600 font-medium">10210913821891</div>
                    <div class="col-span-2 flex flex-col items-end space-y-2">
                        <a href="{{ route('admin.detail_guru')}} " class="bg-blue-400 hover:bg-blue-500 text-white px-4 py-1 rounded-full flex items-center space-x-1 transition-colors text-xs w-20 justify-center">
