...
@section('content')
    <div class="flex flex-col space-y-6">
        ...
        <div class="flex space-x-4">
            <a href="{{route ('admin.data_master')}}" class="px-8 py-2 bg-white text-slate-700 font-semibold rounded-full border-2 border-blue-200 hover:bg-blue-50 transition-colors">
                Kelas
            </a>
            ...
            <a href="{{route ('admin.data_master_guru')}}" class="px-8 py-2 bg-white text-slate-700 font-semibold rounded-full border-2 border-blue-200 hover:bg-blue-50 transition-colors">
             ...
             <a href="{{route ('admin.data_master_mapel')}}" class="px-8 py-2 bg-blue-400 text-white font-semibold rounded-full border-2 hover:bg-blue-500 transition-colors">
                Mata Pelajaran
            </a>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm">
            ...
            <div class="space-y-4 max-h-[600px] overflow-y-auto pr-2">
                ...
                <div class="grid grid-cols-12 gap-4 items-center border-2 border-blue-100 rounded-xl px-6 py-4 bg-white">
                    ...
                    <div class="col-span-5 font-semibold text-slate-800">Nama Mata Pelajaran</div>
                    <div class="col-span-4 flex items-center space-x-2">
                        <img src="{{ asset('images/noto_school.png') }}" alt="Icon Tahun Ajaran" class="w-7 h-7">
                        <span class="text-blue-600 font-bold">Kelas 2A</span>
                    </div>
                    <div class="col-span-2 flex flex-col items-end space-y-2">
                        <a href="{{route ('admin.detail_mapel')}}" class="bg-blue-400 hover:bg-blue-500 text-white px-4 py-1 rounded-full flex items-center space-x-1 transition-colors text-xs w-20 justify-center">
