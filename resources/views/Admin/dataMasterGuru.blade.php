...
<div class="flex justify-end">
    <a href="{{ route('admin.data-master.guru.create') }}" class="bg-blue-400 hover:bg-blue-500 text-white px-6 py-3 rounded-full font-bold flex items-center space-x-2 shadow-lg transition-all hover:shadow-xl">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
