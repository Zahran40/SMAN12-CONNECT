...
<div class="flex flex-col h-full space-y-4 sm:space-y-6">
    ...
    <div class="overflow-x-auto scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0">
        <div class="flex space-x-3 min-w-max">
            ...
            <a href="{{ route('admin.data-master.kelas.guru', $kelas->id_kelas) }}" class="px-6 sm:px-8 py-2 bg-blue-400 text-white font-semibold rounded-full shadow-sm hover:bg-blue-500 transition-colors whitespace-nowrap">
                Guru
            </a>
