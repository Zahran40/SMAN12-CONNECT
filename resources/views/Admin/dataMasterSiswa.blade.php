...
<div class="flex flex-col h-full space-y-6">
    ...
    <div class="flex space-x-4">
        <a href="{{route ('admin.data_master_siswa1')}}" class="px-8 py-2 bg-blue-400 text-white font-semibold rounded-full shadow-sm hover:bg-blue-500 transition-colors">
            Siswa
        </a>
        <a href="{{route ('admin.data_master_guru1')}}" class="px-8 py-2 bg-white text-slate-700 font-semibold rounded-full border-2 border-blue-200 hover:bg-blue-50 transition-colors">
            Guru
        </a>
    ...
    <div class="bg-white p-8 rounded-2xl shadow-sm grow">
        ...
        <div class="max-h-96 overflow-y-auto space-y-4">
            @for ($i = 0; $i < 6; $i++)
                ...
                <div class="col-span-1 font-bold text-slate-700 flex items-center justify-center bg-blue-100 w-8 h-8 rounded-lg">{{ $i + 1 }}</div>
                <div class="col-span-4 font-semibold text-slate-800">Nama Siswa</div>
