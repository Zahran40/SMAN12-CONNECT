...
@section('content')
  ...
  <h2 class="text-3xl font-bold text-slate-800 mb-4 sm:mb-6">Materi Kelas Saya</h2>
    ...
    <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8">
        ...
        <p class="text-sm text-slate-500 mb-6 sm:mb-8">Pilih Mata Pelajaran anda untuk mengisi nilai pada raport siswa</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            <div class="bg-white rounded-3xl border-2 border-blue-400 p-4 sm:p-6 flex flex-col shadow-sm">
                ...
                <a href="{{ route('guru.detail_raport_siswa') }}" class="w-full bg-blue-400 text-white text-center font-bold text-lg py-3 rounded-full hover:bg-blue-500 transition-colors mt-auto">
                    Pergi
                </a>
            </div>
