...
@section('content')
    ...
    <h2 class="text-3xl font-bold text-blue-500 mb-6">Materi Kelas Saya</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        @forelse($jadwalMengajar as $group)
            @php
                $jadwal = $group->first();
            @endphp
            <div class="bg-white rounded-xl p-6 flex flex-col items-center text-center  shadow-md border-2 border-transparent hover:border-blue-300">
                ...
                <div class="w-32 h-32 rounded-full bg-yellow-400 flex items-center justify-center mb-6 ">
                ...
                <a href="{{ route('guru.detail_materi', $jadwal->id_jadwal) }}" class="w-full bg-blue-500 text-white font-semibold py-3 px-6 rounded-xl text-center hover:bg-blue-600   flex items-center justify-center space-x-2">
