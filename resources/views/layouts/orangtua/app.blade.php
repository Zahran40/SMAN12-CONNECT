...
<head>
    ...
    <title>@yield('title', 'Dashboard Orang Tua') | SMAN 12 Connect</title>
...
<body class="bg-slate-100">
    ...
    <div class="flex flex-col h-screen">
        ...
        <header class="bg-purple-500 text-white p-2.5 sm:p-3 flex justify-between items-center shadow-md z-20 relative">
            ...
            <div class="flex items-center gap-2 sm:gap-3 flex-1 lg:flex-initial justify-center lg:justify-start">
                ...
                <div class="hidden sm:block">
                    ...
                    <p class="text-xs text-purple-100">Portal Orang Tua</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3">
                <div class="text-right hidden md:block">
                    ...
                    <p class="text-xs text-purple-100">Orang Tua</p>
                </div>
        ...
        <div class="flex flex-1 overflow-hidden relative">
            ...
            @include('layouts.orangtua.sidebar')
