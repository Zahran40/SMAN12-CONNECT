...
<body class="bg-slate-100">
    ...
    <div class="flex flex-col h-screen">
        ...
        <header class="bg-blue-400 text-white p-2.5 flex justify-between items-center shadow-md z-10">
            ...
            <a href="{{ route('login') }}" class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center text-white hover:bg-white/30 focus:bg-white/30 focus:outline-none focus:ring-2 focus:ring-white/50" aria-label="Profil Siswa">
    <img
        src="{{ asset('images/solar_logout-3-bold.png') }}"
        alt="Profil Siswa"
