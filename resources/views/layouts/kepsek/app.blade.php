...
<body class="bg-slate-100">
    ...
    <div class="flex flex-col h-screen">
        ...
        <header class="bg-gradient-to-r from-indigo-600 to-indigo-700 text-white p-2.5 sm:p-3 flex justify-between items-center shadow-lg z-20 relative">
            ...
            <div class="flex items-center gap-2 sm:gap-3 flex-1 lg:flex-initial justify-center lg:justify-start">
                ...
                <div class="hidden sm:block">
                    ...
                    <p class="text-xs text-indigo-100">Portal Kepala Sekolah</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3">
                <div class="text-right hidden md:block">
                    ...
                    <p class="text-xs text-indigo-100">Kepala Sekolah</p>
                </div>
