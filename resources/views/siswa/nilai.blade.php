...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center space-x-3">
                <span class="text-sm font-medium text-slate-600">Tahun Ajaran {{ $tahunAjaranLabel }}</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div style="background-image: url('{{ asset('images/Frame 115 (2).png') }}')" 
                ...
                <div class="space-y-4">
                    ...
                    <a href="{{ route('siswa.detail_raport', ['semester' => 'Ganjil']) }}" class="inline-block bg-white text-blue-700 font-semibold px-6 py-2 rounded-full text-sm hover:bg-slate-100 transition-colors">
                        Lihat
                    </a>
                </div>
            </div>
            ...
            <div style="background-image: url('{{ asset('images/Frame 115 (2).png') }}')" 
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-sm text-blue-100">Nilai Akhir Semester</p>
                    <a href="{{ route('siswa.detail_raport', ['semester' => 'Genap']) }}" class="inline-block bg-white text-blue-700 font-semibold px-6 py-2 rounded-full text-sm hover:bg-slate-100 transition-colors">
                        Lihat
                    </a>
                </div>
            </div>
