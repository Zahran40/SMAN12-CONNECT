    ...
    <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl p-8 mb-6 text-white shadow-lg">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-purple-50 text-sm mt-2">Pantau perkembangan akademik dan aktivitas anak Anda secara real-time</p>
            </div>
            <div class="hidden md:block">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="w-24 h-24 text-purple-200">
