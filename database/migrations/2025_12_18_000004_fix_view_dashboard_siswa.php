...
return new class extends Migration
{
     ...
     * Run the migrations.
     * 
     * Memperbaiki view_dashboard_siswa untuk menggunakan function fn_calculate_nilai_akhir
     * setelah kolom nilai_akhir dihapus dari tabel nilai
     */
    public function up(): void
    {
        DB::unprepared("
            ...
            SELECT 
                ...
                AVG(fn_calculate_nilai_akhir(n.nilai_tugas, n.nilai_uts, n.nilai_uas)) AS rata_rata_nilai
            FROM siswa s
    ...
    {
        // Kembalikan ke versi lama (dengan nilai_akhir)
        DB::unprepared("
            CREATE OR REPLACE VIEW view_dashboard_siswa AS
            SELECT 
                s.id_siswa,
